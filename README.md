...
<p align="center">
  <img src="docs/screenshots/权限设置页.png" width="260" alt="系统权限设置弹窗" />
</p>
...
**处理方式：**
本软件**实际上并不需要、也没有在代码中申请**上述界面中列出的绝大多数权限（例如获取应用列表、读写剪贴板、媒体音量控制等）。
...
任何人都可以免费获取、使用、修改和分发本软件及其源代码，**但严格禁止将本软件及源代码用于任何形式的商业用途**。

详细的许可条款请参阅项目根目录下的 [LICENSE](file:///d:/003-AI_coding/MiTime/LICENSE) 文件。
